...
- [ ] Machete 2P §6 (superficies, `dS`, flujo) y §7 (divergencia y Gauss). **30 min, sin resolver.**
...
- [ ] Machete 1P §3 (implícita) y §8 (plano tangente). **20 min.**
...
- [ ] Machete 2P §9 (EDO 2º orden). **15 min.**
...
- [ ] Machete 1P §1 (gradiente y direccional). **15 min.**
...
- [ ] Machete unificado, dos lecturas. **45 min.**
...
- `repaso/flashcards.md` + `flashcards-anki.tsv` → antes del D6.
- `repaso/machete.md` unificado (1P + 2P, con tabla de decisión) → antes del D9.
