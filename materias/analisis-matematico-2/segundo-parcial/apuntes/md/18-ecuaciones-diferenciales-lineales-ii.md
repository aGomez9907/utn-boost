...
> ⚠️ **Corrección (editorial, 2026-07-06):** la fórmula de arriba (tal como quedó de la transcripción) solo vale si $q=1$. Para la característica general $m^2 + p\,m + q = 0$ con discriminante negativo, las raíces son $m = \alpha \pm \beta i$ con
>
> $$\alpha = -\frac{p}{2}, \qquad \beta = \frac{\sqrt{4q - p^2}}{2}$$
>
> Verificación con el Ejercicio 7 de abajo: $m^2+2m+5=0$ → $\beta = \frac{\sqrt{20-4}}{2} = 2$ ✓ (con la fórmula sin $q$ daría $0$ ✗). En la práctica: resolvé la característica y leé $\alpha$ y $\beta$ directamente de las raíces complejas.
