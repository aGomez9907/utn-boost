...
> Guía de poda para estudiar contra reloj (examen **8/7**). Cruza las secciones de los 19 apuntes con lo que **realmente cae** en los parciales (ver `examenes/INDICE.md`).
>
...
*Generado el 2026-07-04. Contraste: 19 apuntes de `apuntes/md/` vs. 16 parciales de `examenes/INDICE.md`. La poda es para aprobar el 2° parcial; no descarta el valor conceptual del material.*
