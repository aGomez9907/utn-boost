...
- **Año/cuatrimestre:** 2026 · turno de finales de julio
- **Carrera/facultad:** UTN FRBA _(carrera: completar)_
...
- **Videos:** no hay.
- **Documentos:** no hay material de cursada. Todo el estudio sale de exámenes reales y
  sus resoluciones oficiales.
- **Exámenes reales:** ~45 finales de 2016 a 2026 en `final/examenes/`
  (`AAAA-MM-DD_Final.<ext>`, formatos docx/pdf/jpg). Resoluciones oficiales en
  `final/examenes/resoluciones/` (`AAAA-MM-DD_Final_resolucion.<ext>`). Fotos aún sin
  fecha confirmada en `final/examenes/_por-clasificar/` (se resuelven al indexar).
