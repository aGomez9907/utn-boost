...
Todos los archivos están en `parciales/segundo-parcial/` con nombre `AAAA-MM-DD_Parcial.pdf|png|jpg`.
...
- **`Parciales varios.pdf`** (se dejó **sin renombrar**): es una **compilación de PRIMEROS parciales** (Mayo/Agosto/Octubre 2019, Evaluación Integradora Oct 2020) y apuntes de teoría (Hessiano, extremos ligados). **No corresponde al dataset del segundo parcial** y no tiene una fecha única, por eso quedó con su nombre original. Conviene moverlo a otra carpeta para no ensuciar el análisis.

---

*Generado el 2026-06-30 y actualizado el mismo día con los apuntes 17-19 de Ecuaciones Diferenciales. Fuente: 20 parciales (2014–2023) + 19 apuntes propios, carpeta `parciales/segundo-parcial` y `apuntes/segundo-parcial`.*
