...
transcripción y la guarda como JSON en apuntes/transcripts/NN-<slug>.json. La generación
...
Uso:
    python fetch_transcripts.py           # baja los que faltan (saltea los ya bajados)
    python fetch_transcripts.py --force   # rebaja aunque el JSON ya exista

Si tu 'python' no tiene las dependencias, usá el venv del repo:
    venv/bin/python fetch_transcripts.py
"""
...
OUT_DIR = Path("apuntes/transcripts")
