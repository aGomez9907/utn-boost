...
>
> **Cómo buscar** (desde `parciales/segundo-parcial/`):
> ```bash
> grep -n "#EDO" INDICE-parciales.md              # todos los ítems de ecuaciones diferenciales
> grep -n "#Flujo" INDICE-parciales.md            # todos los flujos
> grep -B1 "#Conservativo" INDICE-parciales.md    # conservativos, con la línea de fecha arriba
> grep -n "^## " INDICE-parciales.md              # listar todos los exámenes por fecha
> ```
...
- **`Parciales varios.pdf`** — NO es un segundo parcial: compilación de **primeros parciales** (2019/2020) + teoría de extremos (Hessiano). Se dejó sin renombrar. Conviene moverlo fuera de esta carpeta.
